...
class egera extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        return Async\async(function () use ($params) {
            $response = Async\await($this->publicGetStatsTickerJson ($params));
            $result = array();
    ...
    public function fetch_currencies($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->privateGet (array_merge($request, $params)));
            $ids = is_array($response) ? array_keys($response) : array();
            $result = array();
            for ($i = 0; $i < count($ids); $i++) {
                $id = $ids[$i];
    ...
    public function fetch_tickers($symbols = null, $params = array ()) {
        return Async\async(function () use ($symbols, $params) {
            ...
            $tickers = Async\await($this->publicGetStatsTickerJson ($params));
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->publicGetStatsOrderbookBaseQuoteJson (array_merge($request, $params)));
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->publicGetStatsHistoryBaseQuoteJson (array_merge($request, $params)));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            return Async\await($this->privateGet (array_merge($request, $params)));
        }) ();
    }
